 ...
 * @returns
 */
export const setupTests = async ({ signal, headless, onlyExtension, testPath }: Readonly<{ signal: AbortSignal; headless: boolean; onlyExtension: string; testPath: string }>): Promise<{ port: number; browser: any; page: any; child: any }> => {
